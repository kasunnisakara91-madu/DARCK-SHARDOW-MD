...
const BOT_NAME_FANCY = 'DARCK SHARDOW';
...
const config = {
  ...
  RCD_IMAGE_PATH: 'https://i.ibb.co/fV79ZwSp/915ebad2c8fc.jpg',
  NEWSLETTER_JID: [
      '120363421785026867@newsletter'],
  OTP_EXPIRY: 300000,
  OWNER_NUMBER: process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(',') : ['94787940686','94703680232'],
  CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb7Lf8I9sBI8QXTIZv1P',
  BOT_NAME: '© DARCK SHARDOW',
  BOT_VERSION: '1.0.0 ULTRA',
  OWNER_NAME: 'VSHWA DESHAN',
  IMAGE_PATH: 'https://i.ibb.co/fV79ZwSp/915ebad2c8fc.jpg',
  BOT_FOOTER: '> *© DARCK SHARDOW*',
...
✅ ༺ DARCK SHARDOW 𝗦𝘆𝘀𝘁𝗲𝗺 𝗶𝘀 𝗻𝗼𝘄 𝗼𝗻𝗹𝗶𝗻𝗲 & 𝗿𝗲𝗮𝗱𝘆!`,
  useBotName
);
...
💻 Powered by *DARCK SHARDOW* | 🇱🇰 Sri Lanka`
    }, { quoted: msg });
    break;
      ...
      case 'tourl':
        ...
        case 'upload': {
          ...
          const metaQuote = {
            ...
            message: { contactMessage: { displayName: "DARCK SHARDOW", vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:Upload Service\nORG:Catbox/ImgBB\nEND:VCARD` } }
          };
...
case 'csong': {
    try {
        ...
        try {
            ...
            const _0x6368616d61 = "Powered by ༺ DARCK SHARDOW"; 
  ...
  try {
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || '© DARCK SHARDOW ||🍃';
...
case 'alive': {
        ...
        case 'owner': {
          ...
          // ✅ BOT NAME
          const BOT_NAME = "DARCK SHARDOW";

          // ✅ OWNER DETAILS
          const ownerName = "DARCK SHARDOW";
          const ownerNumber = "94703680232"; // without +
          const displayNumber = "+94 70 368 0232";
          const email = "DARCKSHARDOW@email.com"; // optional
...
case 'song': {
  ...
  try {
    ...
    const caption = `*© DARCK SHARDOW 𝗦ᴏɴɢ 𝗗ᴏᴡɴʟᴏᴀᴅᴇʀ*
...
case 'tiktokdl': {
  ...
  try {
    await socket.sendMessage(sender, {
      text: '*⏳ Downloading your TikTok video...DARCK SHARDOW*'
    }, { quoted: msg });
